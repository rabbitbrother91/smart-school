                                        ...
                                        <?php if (!$adm_auto_insert) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="admission_no" name="admission_no"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="roll_no" name="roll_no" placeholder="" type="text"
                                                           class="form-control"
                                                           value="<?php echo set_value('roll_no'); ?>"/>
                                        ...
                                        if ($sch_setting->is_blood_group) {
                                            ...
                                            <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    ?>
                                                    <select class="form-control" rows="3" placeholder=""
                                                            name="blood_group">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <button type="button" class="btn btn-sm mysiblings anchorbtn "><i
                                                                class="fa fa-plus"></i> <?php echo $this->lang->line('add_sibling'); ?>
                                                    </button>
                                                </div>
                                                <div class="col-md-7">
                                    ...
                                    <div class="row around10">
                                                        ...
                                                        <optgroup label=" <?php echo $vehroute['route_title']; ?>">
                                                            ...
                                                            if (!empty($vehicles)) {
                                                                foreach ($vehicles as $key => $value) {
                                                                    ...
                                                                    <option value="<?php echo $value->vec_route_id ?>" <?php echo set_select('vehroute_id', $value->vec_route_id); ?>
                                                                            data-fee="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="pickup_point"
                                                ...
                                                <select class="form-control" id="transport_feemaster_id"
                                                    ...
                                                    foreach ($transport_fees as $key => $value) {
                                                        ...
                                                        <option <?php echo set_select('transport_feemaster_id[]', $value['id']); ?>
                                                                value="<?php echo $value['id']; ?>"> <?php echo $this->lang->line(strtolower($value['month'])); ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                                    ...
                                                                    <div class="panel-heading pt5 pb5">
                                                                        <h6 class="panel-title panel-title1 overflow-hidden">
                                                                            <input class="fee_group_chk vertical-middle"
                                                                                   ...
                                                                                   value="<?php echo $feesessiongroup_value->id; ?>" <?php echo set_checkbox('fee_session_group_id[]', $feesessiongroup_value->id); ?>>
                                                                            ...
                                                                            <span class="float-right bmedium pt3 fee_group_total"
                                                                    ...
                                                                    <div id="collapse_fees_<?php echo $feesessiongroup_value->id ?>"
                                                                        ...
                                                                        <ul class="list-group student_fee_list ui-sortable">
                                                                            <li class="list-group-item">
                                                                                ...
                                                                                <div class="tools bmedium font14"><?php echo $this->lang->line('amount'); ?>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input class="filestyle form-control" type='file'
                                                                name='father_pic' id="file" size='20'/>
                                                    </div>
                                                    <span class="text-danger"><?php echo form_error('file'); ?></span>
                                                </div>
                                            </div>
                                        ...
                                        if ($sch_setting->mother_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input class="filestyle form-control" type='file'
                                                                name='mother_pic' id="file" size='20'/>
                                                    </div>
                                                    <span class="text-danger"><?php echo form_error('file'); ?></span>
                                                </div>
                                            </div>
                                    ...
                                    if ($sch_setting->guardian_name) {
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <label><?php echo $this->lang->line('if_guardian_is'); ?><small
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                if ($sch_setting->guardian_phone) {
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('guardian_phone'); ?></label><small
                                                                    class="req"> *</small>
                                            ...
                                            if ($sch_setting->local_identification_no) { ?>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="samagra_id" name="samagra_id" placeholder=""
                                                               type="text" class="form-control"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="radio" style="margin-top: 2px;">
                                                        ...
                                                        <label><input class="radio-inline" checked="checked"
                                                                      type="radio" name="rte" value="No" <?php
