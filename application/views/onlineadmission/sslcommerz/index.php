                        ...
                        <div class="paymentbg">
                            ...
                            ?></td>
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-success"> <?php echo $this->lang->line("pay_with_sslcommerz"); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                    </tr>
                                </table>
                            </form>
                            </div>
