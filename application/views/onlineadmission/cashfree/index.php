                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <form action="<?php echo base_url(); ?>onlineadmission/cashfree/pay" method="post">
                                    <table class="table2" width="100%">
                                        <tr class="bordertoplightgray">
                                            <td  bgcolor="#fff"><?php echo $this->lang->line('phone') ?>:</td>
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control"  name="phone" value="<?php echo set_value('phone', $buyer_data->mobileno); ?>" /> <span class="alert-danger"> <?php echo form_error('phone');?></span></td>
                                        </tr>
                                        <tr class="bordertoplightgray">
                                            <td  bgcolor="#fff"><?php echo $this->lang->line('email'); ?>:</td>
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="email" value="<?php echo set_value('email', $buyer_data->email); ?>"> <span class="alert-danger"> <?php echo form_error('email');?></span></td>
                                        </tr>
                                        <tr>
                            ...
                            ?></td>
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-success"><?php echo $this->lang->line('pay_with_cashfree'); ?> <i class="fa fa fa-chevron-right"></i> </button>  </td>
                                        </tr>
                                    </table>
