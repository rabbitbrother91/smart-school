                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                           <div class="invtext"><?php echo $this->lang->line('payment_details'); ?> </div>
                            ...
                            <form action="https://<?php echo $pfHost; ?>/eng/process" method="post" name="pay_now">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-success"> <?php echo $this->lang->line('pay_with_payfast'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                    <?php  
                                           foreach($htmlForm as $name=> $value)
                                            {
