                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <form action="<?php echo base_url(); ?>onlineadmission/walkingm/pay" method="post">
                                   ...
                                   <tr class="border_bottom">
                                       ...
                                       <?php 
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-success"><?php echo $this->lang->line('pay_with_walkingm'); ?> <i class="fa fa fa-chevron-right"></i> </button>  </td>
                                        </tr>
                                    </table>
